  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogTrigger asChild>
        <Button size="sm" className="bg-primary hover:bg-primary-dark text-black font-semibold h-7 rounded-md px-2 cursor-pointer text-xs">
              ...
              {Object.entries(routesByDomain).map(([domainId, domainRoutes]) => {
                ...
                return (
                  <div key={domainId} className="flex flex-col pb-2">
                    {/* Domain Header Group */}
                    <div className="flex items-center gap-1.5 px-3 py-1.5 bg-muted/20 border-b border-border/40 text-[9px] font-mono font-bold text-muted-foreground uppercase tracking-wider select-none">
                    ...
                    <div className="divide-y divide-border/10">
                      {domainRoutes.map((route) => {
                        ...
                        return (
                          ...
                          >
                            <span
                              className={`mt-0.5 shrink-0 rounded-[3px] border px-1.5 py-0.5 text-[9px] font-bold leading-tight ${
                            ...
                            <div className="min-w-0 flex-1 pl-0.5">
                              ...
                              <div className="mt-0.5 flex items-center gap-2">
                                <span className="text-[10px] font-mono font-semibold text-muted-foreground">{route.statusCode}</span>
...
function RouteEditor({
  ...
  return (
    <div className="flex h-full min-h-0 flex-col bg-background">
      {/* Route header */}
      <div className="flex items-center gap-3 border-b px-4 py-2 bg-muted/10 shrink-0">
        <span
          className={`rounded-[3px] border px-2 py-0.5 text-xs font-bold ${
            METHOD_COLORS[route.method] ?? ''
          }`}
        >
          {route.method}
        ...
        {domain && (
          <span className="text-xs text-muted-foreground font-mono">on {domain.hostname}</span>
        )}
        <div className="ml-auto flex items-center gap-2">
          ...
          <Button
            variant="ghost"
            size="icon"
            className="h-7 w-7 text-muted-foreground hover:text-red-400 hover:bg-red-500/10 cursor-pointer rounded"
      ...
      <ScrollArea className="flex-1">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-5 p-4 items-start">
          
          {/* Left Column: General Configuration & Matchers & Chaos */}
          <div className="space-y-5">
            <div className="space-y-4 rounded-lg border border-border p-4 bg-muted/5">
              <h4 className="text-xs font-bold text-foreground uppercase tracking-wider pb-1 border-b border-border/50">Route Config</h4>
              <div className="flex gap-4">
                <div className="w-24 space-y-1.5">
                  ...
                  <Input
                    ...
                    className="text-center font-mono text-sm h-8 bg-muted/20 focus-visible:ring-primary focus-visible:ring-1"
                  />
                </div>
                <div className="flex-1 space-y-1.5">
                  ...
                  >
                    <SelectTrigger className="text-xs h-8 bg-muted/20">
                      <SelectValue />
                    </SelectTrigger>
                    <SelectContent>
                      {domains.map((d) => (
            ...
            {/* Chaos Simulation */}
            <div className="space-y-4 rounded-lg border border-border p-4 bg-muted/5">
              <h4 className="flex items-center gap-1.5 text-xs font-bold text-foreground uppercase tracking-wider pb-1 border-b border-border/50">
          ...
          {/* Right Column: Response Headers & Response Body Editor */}
          <div className="space-y-5">
            <div className="space-y-4 rounded-lg border border-border p-4 bg-muted/5">
              <h4 className="text-xs font-bold text-foreground uppercase tracking-wider pb-1 border-b border-border/50">Response Headers</h4>
              <div className="space-y-2">
            ...
            <div className="space-y-4 rounded-lg border border-border p-4 bg-muted/5 flex flex-col">
              <div className="flex items-center justify-between border-b border-border/50 pb-1 shrink-0">
              ...
              <div className="h-[280px] rounded border border-border overflow-hidden bg-code-bg mt-2 flex-1">
                <TextEditor
                  value={body}
