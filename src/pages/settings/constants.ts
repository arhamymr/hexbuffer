...
export const INSTALLATION_GUIDES = [
  {
    ...
    steps: [
      ...
      'Click "Import" and select the saved seven-ca.pem file',
  ...
  },
  {
    ...
    steps: [
      ...
      'Select the saved seven-ca.pem file',
  ...
  },
  {
    ...
    steps: [
      ...
      'Import the saved seven-ca.pem file',
  ...
  },
  {
    ...
    steps: [
      ...
      'Enable full trust for "Seven Root CA"',
    ],
    note: {
      Icon: InfoIcon,
...
export const HOW_IT_WORKS = [
  {
    ...
    body: 'When you first run the proxy, Seven Project generates a unique Root CA certificate stored locally on your device.',
  },
  {
    title: '2. CA Installation',
    body: 'Installing this CA in your browser/device tells it to trust certificates signed by Seven Project.',
  },
  {
    title: '3. Dynamic Certificate Signing',
    body: 'When you visit an HTTPS site (e.g., example.com), the proxy dynamically creates a certificate for that site, signed by the trusted Seven Project CA.',
  },
  {
  ...
  },
  {
    ...
    body: 'Only traffic passing through Seven Project proxy is intercepted. Your browsing outside the proxy remains private.',
  },
];
...
export const TROUBLESHOOTING_GUIDES = [
  ...
  },
  {
    ...
    bullets: [
      'Windows: Internet Options → Content → Certificates → Authorities → Select "Seven Project Root CA" → Remove',
      'macOS: Keychain Access → System → Certificates → Delete "Seven Project Root CA"',
      'Firefox: Options → Privacy → Certificates → View Certificates → Authorities → Delete',
      'iOS: Settings → General → Profiles → Delete Seven Project profile',
