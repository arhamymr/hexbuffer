  ...
  return (
    <div className="flex h-full flex-col">
      <div className="bg-muted flex h-10 items-center justify-between border-b px-3 py-2">
        ...
        <div className="flex items-center gap-2">
          <Button size="xs" variant="outline" onClick={onDrop} disabled={!hasSelection || isBusy}>
              ...
              {requests.map((request) => {
                ...
                return (
                  <button
                    ...
                    className={cn(
                      'grid w-full grid-cols-[auto_minmax(0,1fr)_auto] items-start gap-2 px-3 py-2 text-left text-sm hover:bg-muted/60',
                      isSelected && 'bg-muted'
                    )}
                  >
