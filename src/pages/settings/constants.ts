...
export const INSTALLATION_GUIDES = [
  {
    ...
    steps: [
      ...
      'Click "Import" and select the saved apprecon-ca.pem file',
  ...
  },
  {
    ...
    steps: [
      ...
      'Select the saved apprecon-ca.pem file',
  ...
  },
  {
    ...
    steps: [
      ...
      'Import the saved apprecon-ca.pem file',
  ...
  },
  {
    ...
    steps: [
      ...
      'Enable full trust for "Apprecon Root CA"',
    ],
    note: {
      Icon: InfoIcon,
...
export const HOW_IT_WORKS = [
  {
    ...
    body: 'When you first run the proxy, Apprecon generates a unique Root CA certificate stored locally on your device.',
  },
  {
    title: '2. CA Installation',
    body: 'Installing this CA in your browser/device tells it to trust certificates signed by Apprecon.',
  },
  {
    title: '3. Dynamic Certificate Signing',
    body: 'When you visit an HTTPS site (e.g., example.com), the proxy dynamically creates a certificate for that site, signed by the trusted Apprecon CA.',
  },
  {
  ...
  },
  {
    ...
    body: 'Only traffic passing through Apprecon proxy is intercepted. Your browsing outside the proxy remains private.',
  },
];
...
export const TROUBLESHOOTING_GUIDES = [
  ...
  },
  {
    ...
    bullets: [
      'Windows: Internet Options → Content → Certificates → Authorities → Select "Apprecon Root CA" → Remove',
      'macOS: Keychain Access → System → Certificates → Delete "Apprecon Root CA"',
      'Firefox: Options → Privacy → Certificates → View Certificates → Authorities → Delete',
      'iOS: Settings → General → Profiles → Delete Apprecon profile',
