...
const CHAT_INSTRUCTIONS = [
  ...
  'Invoker workflow: use sendToInvoker with a proxy log ID to configure and launch an invoker attack. Provide rawRequest with $ markers to control what gets fuzzed, and payloadValues with common test values.',
