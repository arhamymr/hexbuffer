...
import {
  ...
  createAddScopeTool,
  createDeleteScopeTool,
  createDeleteAllScopesTool,
...
export async function runChat() {
  ...
  const createChatAgent = () => new ToolLoopAgent({
    ...
    tools: {
      ...
      deleteScope: createDeleteScopeTool(emitAction),
      deleteAllScopes: createDeleteAllScopesTool(emitAction),
      ...
      pauseScan: createPauseScanTool(emitAction),
      resumeScan: createResumeScanTool(emitAction),
      stopScan: createStopScanTool(emitAction),
      submitCrawlCredentials: createSubmitCrawlCredentialsTool(emitAction),
      navigateTo: createNavigateToTool(emitAction),
      requestHumanSelection: createRequestHumanSelectionTool(emitAction),
    },
  });
