...
const TauriTerminal = React.lazy(() =>
  import('./terminal').then((m) => ({ default: m.TauriTerminal }))
);
import {
  ResizableHandle,
  ResizablePanel,
...
const TERMINAL_PANEL_MIN_SIZE = 10;
    ...
    <div className="h-screen overflow-hidden bg-background flex flex-col rounded-md border shadow-2xl">
      ...
      <main className="relative flex min-h-0 flex-1 overflow-hidden">
        <ResizablePanelGroup orientation="vertical">
          <ResizablePanel defaultSize={isTerminalOpen ? 100 - TERMINAL_PANEL_DEFAULT_SIZE : 100} minSize={30}>
