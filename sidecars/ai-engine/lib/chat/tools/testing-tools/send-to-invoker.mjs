...
export function createSendToInvokerTool(emitAction) {
  return tool({
    description: 'Send a proxy HTTP request to the Invoker (intruder) tool. The app will configure the attack with the request, auto-detect payload positions from § markers, and open the Invoker page. Use this when you want to brute-force, fuzz, or test parameters on an endpoint.',
    ...
    execute: async ({ logId, rawRequest, payloadValues, delayMs }) => {
      emitAction({
