...
Treat certificate material, database files, HAR captures, and proxy logs as sensitive. Avoid committing new secrets or local runtime artifacts from `src-tauri/.0xbufferr/`, `src-tauri/data/`, or generated output directories unless intentionally required.
