...
import type { CollaboratorServer, CreateServerRequest } from '../types';
...
interface Props {
  ...
  onAddServer: (req: CreateServerRequest) => Promise<CollaboratorServer>;
  onDeleteServer: (id: string) => Promise<void>;
  onCheckHealth: (id: string) => Promise<CollaboratorServer>;
}
    ...
    <div className="flex h-full min-h-0 flex-col">
      <div className="flex h-10 shrink-0 items-center justify-between border-b bg-muted px-3 py-2">
        ...
        <Dialog open={dialogOpen} onOpenChange={handleDialogOpenChange}>
          ...
          <DialogContent>
            <DialogHeader>
              <DialogTitle>Add Collaborator Server</DialogTitle>
            </DialogHeader>
            <Form {...form}>
      ...
      <div className="min-h-0 flex-1 overflow-auto p-2">
        {servers.length === 0 ? (
          <div className="flex h-full items-center justify-center text-xs text-muted-foreground">
            No servers configured. Add a collaborator server to get started.
          </div>
        ) : (
